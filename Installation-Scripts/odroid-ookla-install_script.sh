...
wget -O /home/iperf-scripts/execute_test_final_ookla.py https://raw.githubusercontent.com/GuillermoElectrico/hyperspeed-tester/master/Client-Script/execute_test_final_ookla.py
...
wget -O /home/iperf-scripts/button_script_ookla.py https://raw.githubusercontent.com/GuillermoElectrico/hyperspeed-tester/master/Client-Script/button_script_ookla.py
wget -O /home/iperf-scripts/button_shell_script_ookla.sh https://raw.githubusercontent.com/GuillermoElectrico/hyperspeed-tester/master/Client-Script/button_shell_script_ookla.sh
chmod +x /home/iperf-scripts/button_shell_script_ookla.sh
sleep 2
echo *******Setting Cron to execute on startup for script execution********
(crontab -l 2>/dev/null; echo "@reboot python /home/iperf-scripts/button_script_ookla.py") | crontab -
(crontab -l 2>/dev/null; echo "@reboot sleep 1 ;python /home/iperf-scripts/boot.py") | crontab -
(crontab -l 2>/dev/null; echo "@reboot sleep 32; python /home/iperf-scripts/execute_test_final_ookla.py") | crontab -
echo *******Setup complete*******
sleep 2
